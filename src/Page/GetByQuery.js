...
flex-direction:row;
`
export default function GetByQuery() {
    ...
    const getLists = ()=>{
        ...
        axios.get(`http://localhost:3003/getLists?text=${text}&page=${page}&nameColumn=${nameColumn}&order=${order}&limit=${limit}`)
        .then((response)=>{
    ...
    <MainContainer>
        <ContainerHeader>
            ...
            <ContainerFilter>
                ...
                <InputText onChange ={(e)=>{setQuery(e.target.value)}} placeholder="Input the specific message"/>
                ...
                <InputButton  onClick={()=> getLists()}>Search</InputButton> 
